...
const experiments = [
  {
    ...
    description: "Zama FHE treats ciphertexts as first-class Solidity types. You encrypt your bid client-side with @zama-fhe/relayer-sdk; the contract accepts an euint64 and never sees plaintext. The running max is tracked via FHE.max + FHE.select, replacing the old off-chain confidential-compute bidding flow.",
